...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `smart_health`.`apps` ;

CREATE TABLE IF NOT EXISTS `smart_health`.`apps` (
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `smart_health`.`users` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `smart_health`.`integrations` ;

CREATE TABLE IF NOT EXISTS `smart_health`.`integrations` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `deleted` INT NOT NULL DEFAULT 0,
  `created_at` DATETIME NULL,
  `updated_at` DATETIME NULL,
  ...
  CONSTRAINT `fk_appid`
    FOREIGN KEY (`app_id`)
    REFERENCES `smart_health`.`apps` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_uid`
    FOREIGN KEY (`user_id`)
    REFERENCES `smart_health`.`users` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `smart_health`.`activities` ;

CREATE TABLE IF NOT EXISTS `smart_health`.`activities` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `deleted` INT NOT NULL DEFAULT 0,
  `created_at` DATETIME NULL,
  `updated_at` DATETIME NULL,
  ...
  CONSTRAINT `fk_iid`
    ...
    REFERENCES `smart_health`.`integrations` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `smart_health`.`polls` ;

CREATE TABLE IF NOT EXISTS `smart_health`.`polls` (
