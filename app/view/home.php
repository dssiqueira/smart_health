                    ...
                    <div class="mdl-grid">
                        <div class="mdl-cell mdl-cell--12-col">
                            ...
                            <h4>Before start running, let us know where to track your statistics...</h4>
                        </div>
                    </div>
                    <div class="mdl-grid">
                        <div class="mdl-cell mdl-cell--4-col">
							...
							<?php else : ?>
								<a href="https://www.strava.com/oauth/authorize?client_id=11678&response_type=code&redirect_uri=https%3A%2F%2Fssl-310157.uni5.net%2Fintegration%2FsaveStrava&scope=write&state=mystate&approval_prompt=force" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">Connect</a>
							<?php endif; ?>                                
                        ...
                        <div class="mdl-cell mdl-cell--4-col">
							...
							<?php if($isRunkeeperConnected !== FALSE) : ?>
								<form action="integration/disconnect" method="post">
									<input type="hidden" name="appid" value="<?php echo RUNKEEPER_ID; ?>">
									<input type="submit" value="Disconnect" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">								
								</form>
							<?php else : ?>
								    <a href="https://runkeeper.com/apps/authorize?response_type=code&client_id=8ca1c685ee4a4ad88ffcddfe24f3d0cf&redirect_uri=https%3A%2F%2Fssl-310157.uni5.net%2Fintegration%2FsaveRunkeeper" class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">Connect</a>
							<?php endif; ?>                                
                        ...
                        <div class="mdl-cell mdl-cell--4-col">
                            <div class="card-square mdl-card mdl-shadow--2dp">
                                ...
                                <?php if(empty($vote) || $vote == 0) : ?>
										...
										<input type="submit" value="+" class="mdl-button mdl-js-button mdl-button--fab mdl-button--mini-fab mdl-button--colored">								
                                <?php else : ?>
