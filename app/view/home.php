...
<div class="mdl-grid">
	<div class="mdl-cell mdl-cell--12-col">
		...
		<h4>Before start running, let us know where to track your
			statistics...</h4>
	</div>
</div>
<div class="mdl-grid">
	<div class="mdl-cell mdl-cell--4-col">
		<div class="card-square mdl-card mdl-shadow--2dp">
			<div class="mdl-card__title mdl-card--expand"
				style="background: url('img/strava.png');"></div>
			...
			<div class="mdl-card__actions mdl-card--border">
					...
					<input type="submit" value="Disconnect"
						class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">
							...
							<?php else : ?>
								<a
					href="https://www.strava.com/oauth/authorize?client_id=11678&response_type=code&redirect_uri=https%3A%2F%2Fssl-310157.uni5.net%2Fintegration%2FsaveStrava&scope=write&state=mystate&approval_prompt=force"
					class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">Connect</a>
							<?php endif; ?>                                
	...
	<div class="mdl-cell mdl-cell--4-col">
		<div class="card-square mdl-card mdl-shadow--2dp">
			<div class="mdl-card__title mdl-card--expand"
				style="background: url('img/runkeeper.png');"></div>
			<div class="mdl-card__supporting-text">
			...
			<div class="mdl-card__actions mdl-card--border">
					...
					<input type="hidden" name="appid"
						...
						class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">
							...
							<?php else : ?>
								    <a
					href="https://runkeeper.com/apps/authorize?response_type=code&client_id=8ca1c685ee4a4ad88ffcddfe24f3d0cf&redirect_uri=https%3A%2F%2Fssl-310157.uni5.net%2Fintegration%2FsaveRunkeeper"
					class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent">Connect</a>
							<?php endif; ?>                                
	...
	<div class="mdl-cell mdl-cell--4-col">
		<div class="card-square mdl-card mdl-shadow--2dp">
			<div class="mdl-card__title mdl-card--expand"
				style="background: url('img/nikerunning.png');"></div>
			<div class="mdl-card__supporting-text">
...
<div class="mdl-grid">
	<div class="mdl-cell mdl-cell--12-col">
		...
		<h4>So help us to identify where to focus our effort by voting on your
			favorite App below...</h4>
	</div>
</div>
