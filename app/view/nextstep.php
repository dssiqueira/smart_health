					...
					<div class="mdl-grid">
						...
						<div class="mdl-cell mdl-cell--3-col"> 
							<div class="card-square mdl-card mdl-shadow--2dp">
									<div class="mdl-card__title mdl-card--expand" style="background: url('/img/laravel.png');"></div>
						...
						<div class="mdl-cell mdl-cell--3-col"> 
							<div class="card-square mdl-card mdl-shadow--2dp">
									<div class="mdl-card__title mdl-card--expand" style="background: url('/img/angularjs.png');"></div>
									<div class="mdl-card__supporting-text">
						...
						<div class="mdl-cell mdl-cell--3-col"> 
							<div class="card-square mdl-card mdl-shadow--2dp">
									<div class="mdl-card__title mdl-card--expand" style="background: url('/img/materialangular.png');"></div>
									<div class="mdl-card__supporting-text">
					...
					<div class="mdl-grid">
						...
						<div class="mdl-cell mdl-cell--3-col"> 
							<div class="card-square mdl-card mdl-shadow--2dp">
									<div class="mdl-card__title mdl-card--expand" style="background: url('/img/ranking.png');"></div>
									<div class="mdl-card__supporting-text">
						...
						<div class="mdl-cell mdl-cell--3-col"> 
							<div class="card-square mdl-card mdl-shadow--2dp">
									<div class="mdl-card__title mdl-card--expand" style="background: url('/img/site.png');"></div>
									<div class="mdl-card__supporting-text">
						...
						<div class="mdl-cell mdl-cell--3-col"> 
							<div class="card-square mdl-card mdl-shadow--2dp">
									<div class="mdl-card__title mdl-card--expand" style="background: url('/img/multilanguage.png');"></div>
									<div class="mdl-card__supporting-text">
					...
					<div class="mdl-grid">
						...
						<div class="mdl-cell mdl-cell--3-col"> 
							<div class="card-square mdl-card mdl-shadow--2dp">
									<div class="mdl-card__title mdl-card--expand" style="background: url('/img/achievements.png');"></div>
									<div class="mdl-card__supporting-text">
						...
						<div class="mdl-cell mdl-cell--3-col"> 
							<div class="card-square mdl-card mdl-shadow--2dp">
									<div class="mdl-card__title mdl-card--expand" style="background: url('/img/profile.png');"></div>
									<div class="mdl-card__supporting-text">
						...
						<div class="mdl-cell mdl-cell--3-col"> 
							<div class="card-square mdl-card mdl-shadow--2dp">
									<div class="mdl-card__title mdl-card--expand" style="background: url('/img/events.png');"></div>
									<div class="mdl-card__supporting-text">
