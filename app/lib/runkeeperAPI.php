<?php
class runkeeperAPI {
	private $client_id = RUNKEEPER_CLIENT_ID;
	private $client_secret = RUNKEEPER_CLIENT_SECRET;

	private $auth_url = 'https://runkeeper.com/apps/authorize';
	private $access_token_url = 'https://runkeeper.com/apps/token';
	private $redirect_uri = '/integration/saveRunkeeper';
	...
	public function doRunkeeperRequest($name, $type, $fields = null, $url = null, $optparams = null) {
		...
		if (! $name || ! $this->api_conf->Interfaces->$name) {
			...
			if ($this->requestRedirectUrl != null) {
				...
				elseif (in_array ( $responsecode, array (
						'201',
						'204',
						'301',
						'304' 
	...
	public function getAllActivities() {
		...
		curl_setopt_array ( $curl, array (
				CURLOPT_URL => "http://api.runkeeper.com/fitnessActivities?pageSize=99",
				CURLOPT_RETURNTRANSFER => true,
				CURLOPT_ENCODING => "",
				CURLOPT_MAXREDIRS => 10,
				CURLOPT_TIMEOUT => 30,
